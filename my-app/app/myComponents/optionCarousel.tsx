...
function OptionCarousel() {
  return (
    <div className="flex flex-col md:flex-row items-start md:items-center">
      {/* Menu Options */}
      <div className="w-full md:w-auto pl-6 pr-6 md:pl-8 md:pr-12 border-b md:border-b-0 md:border-r border-gray-300">
      ...
      {/* Carousel */}
      <div className="w-full md:w-auto md:flex-1 p-4">
        <Image
          src={img}
          alt="Hero Image"
          width={892}
